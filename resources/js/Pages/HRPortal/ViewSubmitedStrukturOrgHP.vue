    ...
    data () {
      return {
        ds: {
          ...
          'title': 'Ayu Sri Indriyani',
          'children': [
            { 'id': '2', 'name': 'System & Application Development (Analyst) - KJ 7', 'title': 'Panji Agung K / Alfrinaldi T','children':[
                {'id':'5','name':'System & Application Development (Junior Anlayst) - KJ 5','title':'Ardian Bara Adhiansa '}
            ] },
            { 'id': '3', 'name': 'Infrastructure (Senior Analyst - KJ 7)', 'title': 'Rizky Arya Indracahya',
              'children': [
                { 'id': '4', 'name': 'Infrastructure (Tehnician) - KJ 3 ', 'title': 'Bimo Ardiantono' },
               ]
             },
          ]
        }
              ...
              <!-- <table class="table-auto w-full text-sm"> -->
                <thead class="text-lg">
                    <tr>
                        ...
                        <th class="text-center py-3">NRP</th>
                        <th class="text-center py-3">Nama</th>
                        <th  class="text-center py-3">KJ</th>
                        <th  class="text-center py-3">Jabatan</th>
                        <th  class="text-center py-3">Bagian</th>
...
<button class="btn btn-text-xs bg-blue-500 my-1 mx-8" @click="requestUpdateStruktur()">Request Update</button>
