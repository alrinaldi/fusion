...
async function createKompetensiMaster() {
      axios.post('createkompetensimaster', {
...
<template>
  ...
  <p class="font-serif text-2xl mx-8 my-8 underline text-sky-900 decoration-neutral-900">Kompetensi</p>
              ...
              <!-- <table class="table-auto w-full text-sm"> -->
                <thead class="text-lg">
                    <tr>
                        ...
                        <th  class="text-center py-3">Detail Kompetensi</th>
                ...
                <tbody class="text-xl">
                    ...
                    >
                        ...
                        <td class=" py-3 text-gray-900">{{ kompetensi.kategori }}</td>
                        <td class=" py-3 text-gray-900">{{ kompetensi.status }}</td>
                        <td class=" py-3 text-gray-900">{{ kompetensi.type }}</td>
                        <td class=" py-3 text-gray-900">{{ kompetensi.description }}</td>
                        <td class=" py-3 text-gray-900"><a :href="route('hrportal.addlineskompetensidept',kompetensi.id)" class="btn text-sm h-3/5	">Detail</a></td>
                        <td>
                        <label for="my-update" class="btn my-1 mx-8" @click="editRow(kompetensi.id)">Edit </label>
...
<div class="modal">
  <div class="modal-box modal-box w-12/12 max-w-6xl"  >
    <h3 class="font-bold text-lg">Add Kompetensi</h3>
    <hr>
  <form @submit.prevent="createKompetensiMaster" class="mt-3">
    <div class="flex flex-wrap -mx-3 mb-6">
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="description">Kategori</label>
        ...
        <div class="w-full md:w-1/2 px-3">
          ...
          <textarea placeholder="Type Here" class="textarea textarea-bordered textarea-lg w-full h-full	" v-model="description" ></textarea>
