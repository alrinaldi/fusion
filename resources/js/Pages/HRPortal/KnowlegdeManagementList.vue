...
const jtitle = ref('');
// const pdfUrl = ref('../../../../public/storage/files/ai.pdf'); // Ubah sesuai dengan jalur yang benar ke file PDF yang ingin Anda tampilkan
...
<template>
  ...
  <p class="font-serif text-2xl mx-8 my-8 underline text-sky-900 decoration-neutral-900">Knowledge Management</p>

  <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="name">Kategori Knowlegde</label>
            <select class="select select-primary w-1/5" name="kategorikm" v-model="kategorikm"  id="kategorikm">
            ...
            <option value="OTHERS">OTHERS</option>
                ...
                <div class="card w-96 bg-base-100 shadow-xl">
                    <a href="#my-modal-2">
                <figure><img src="../../../../public/storage/images/preview.jpg" alt="Shoes" /></figure>
                <div class="card-body">
                    <h2 class="card-title">
                        New Programing Method With AI
                    <div class="badge badge-secondary">NEW</div>
                    </h2>
                    <p>Programing Method</p>
                    <div class="card-actions justify-end">
                    <div class="badge badge-outline">Viewed: 199</div>
                    <div class="badge badge-outline">Kategori: IT</div>
                    </div>
                </div>
                </a>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="card-actions justify-end">
                    <div class="badge badge-outline">Viewed: 199</div>
                    <div class="badge badge-outline">Kategori: EHS</div>
                    </div>
                </div>
                </a>
                ...
                <div class="card-body">
                    ...
                    <p>People Development Framework</p>
                    <div class="card-actions justify-end">
                    <div class="badge badge-outline">Viewed:100</div>
                    <div class="badge badge-outline">Kategori:HR</div>
                    </div>
                </div>
            </a>
                </div>
                ...
                <div class="card-body">
                    ...
                    <p>Vocabulary</p>
                    <div class="card-actions justify-end">
                    <div class="badge badge-outline">Viewed : 150</div>
                    <div class="badge badge-outline">Kategori : GA</div>
                    </div>
                </div>
                </a>
                </div>
...
<div class="modal" id="my-modal-2">
    ...
    <h3 class="font-bold text-lg">New Programing Method With AI</h3>
    <embed src="http://127.0.0.1:5173/storage/app/public/files/ai.pdf" type="application/pdf" width="100%" height="700px" />
    <div class="modal-action">
