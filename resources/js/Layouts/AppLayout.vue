...
<template>
    <div class="flex relative h-screen">
        ...
        <div
            :class="isOpen ? 'hidden' : ''"
            class="flex flex-col p-3 bg-gray-800 shadow w-52 sticky top-0 h-full"
        >
            <div class="space-y-3">
                <!-- Logo -->
                <Link :href="route('home')">
                    <ApplicationMark class="block ml-1 h-14 w-auto" />
                </Link>
        ...
        <div class="h-full overflow-y-auto bg-gray-100 w-full">
            <!-- Header -->
                ...
                <div class="w-full mx-auto px-4 sm:px-3 lg:px-4">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <!-- Navigation Links -->
                            <!-- <div class="space-x-4 sm:ml-3 sm:-my-px sm:flex">
